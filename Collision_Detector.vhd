...
begin
	t_lane_0_collision <= '1' when ((player_lane = "00" and (lane_0_row <= conv_std_logic_vector(140, 10))) and
											  ((lane_0_obj = '1') or
											  (lane_0_obj = '0' and player_state = '0')))
									  else '0';
									
	t_lane_1_collision <= '1' when ((player_lane = "01" and (lane_1_row <= conv_std_logic_vector(140, 10))) and
											  ((lane_1_obj = '1') or
											  (lane_1_obj = '0' and player_state = '0')))
									  else '0';
									
	t_lane_2_collision <= '1' when ((player_lane = "10" and (lane_2_row <= conv_std_logic_vector(140, 10))) and
											  ((lane_2_obj = '1') or
