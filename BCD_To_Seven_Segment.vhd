...
architecture bcd_to_seven_segment_behaviour of BCD_To_Seven_Segment is
begin
	seven_seg_out <= "1111001" when BCD_digit = "0001" else -- 1
						  ...
						  "0001110" when BCD_digit = "1111" else -- F
						  "1111111";
end architecture bcd_to_seven_segment_behaviour; 