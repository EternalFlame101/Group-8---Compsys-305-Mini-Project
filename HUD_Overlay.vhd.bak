...
architecture beh of HUD_Overlay is
	...
	constant SCORE_X : integer := 312;
	constant SCORE_Y : integer := 150;
	
	
	constant HEALTH_X : integer := 100;
	constant HEALTH_Y : integer := 150;
begin 
	...
	Points : Word_Display
		...
		port map (clock          => video_clock,
                characters     => "110000" & "110000",   -- VARIABLE SCORE -- 0 for now 
