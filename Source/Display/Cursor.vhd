-- ------------------------------------------------------------------------------
-- Cursor
--   Draws a small square mouse cursor of side SIZE_CONST pixels at the given
--   (cursor_x, cursor_y) position. Emits non-zero RGB only inside the cursor box
--   so it composites over other layers using the project's "non-zero = active"
--   convention.
--
