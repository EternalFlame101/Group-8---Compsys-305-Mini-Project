-- ------------------------------------------------------------------------------
-- HUD_Overlay
--   Renders the in-game heads-up display over the active pipeline: lives, score,
--   and the MM:SS timer. Text is drawn from the character ROM; digits use the
--   "11" & digit encoding.
--
--   Character codes verified against tcgrom.mif (octal addresses, index=addr/8):
--     Space = 32  = "100000"
