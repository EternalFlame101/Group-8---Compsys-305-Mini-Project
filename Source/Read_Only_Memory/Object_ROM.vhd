-- ------------------------------------------------------------------------------
-- Object_ROM
--   Lookup table of per-object geometry indexed by track_row. For a given row it
--   returns the object's screen distance, y position, height, width, and the
--   taper parameters used to draw obstacles in perspective as they approach.
--
...
begin
   Altsyncram_Component : altsyncram
      generic map (address_aclr_a         => "none",
                   ...
                   init_file              => "Assets/Memory_Initialization_Files/object_data.mif",
