-- ------------------------------------------------------------------------------
-- Wave_ROM
--   Lookup table of pre-authored obstacle waves. Given a wave address it returns
--   the object type for each of the three lanes (lane_0/1/2_out), letting
--   Spawn_Control play back designed spawn patterns rather than purely random
--   ones.
--
...
begin
   ...
   Altsyncram_Component : altsyncram
      generic map (address_aclr_a         => "none",
                   ...
                   init_file              => "Assets/Memory_Initialization_Files/spawn_patterns.mif",
