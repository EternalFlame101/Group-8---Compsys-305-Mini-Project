-- ------------------------------------------------------------------------------
-- Game_Timer
--   Counts upward in MM:SS format (00:00 -> 99:59). Driven by the system clock; a
--   clock-enable tick is generated internally to produce exactly one "second"
--   increment per second based on the CLOCK_HZ generic. The enable port pauses
--   and resumes the count without resetting it.
--
--   Outputs:
