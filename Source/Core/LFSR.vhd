-- ------------------------------------------------------------------------------
-- lfsr_8bit
--   8-bit maximal-length linear-feedback shift register used as a cheap
--   pseudo-random source for obstacle spawning in Spawn_Control. Advances one
--   step per enabled clock; SEED sets the (non-zero) starting state.
--
--   Only IEEE.std_logic_1164 is needed -- the feedback is pure XOR, no arithmetic.
--
