   ...
   begin
      if reset = '1' then
         ...
         case current_state is
            ...
            when s_high_wait_2 =>
               -- buffer_byte is now the high byte. Sample = (high & low) as signed 16-bit.
               -- Convert to unsigned for DAC by flipping the MSB.
               dac_high_reg  <= (not buffer_byte(7)) & buffer_byte(6 downto 0);
               dac_low_reg   <= low_byte;
